...
<div class="hero-image">
    <div class="hero-content">
        <div class="col-md-4 hero-text">
            <h3>
                Selamat Datang di Toko Green Cloth
            </h3>
            <p>Toko kesayangan para Bonek dan Bonita. Salam Satu Nyali Wani~</p>
...
<div class="container">
    <div class="content-head">
        <h2 style="text-align:center; font-weight: bold">Green Cloth</h2>
